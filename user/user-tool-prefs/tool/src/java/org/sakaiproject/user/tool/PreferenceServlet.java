...
public class PreferenceServlet extends JsfTool {
	...
	{
		String defaultPreference="prefs_editor_title, prefs_noti_title, prefs_timezone_title, prefs_lang_title, prefs_hidden_title";
		String Editor="prefs_editor_title", Notification="prefs_noti_title", Timezone="prefs_timezone_title", Language="prefs_lang_title", Hidden="prefs_hidden_title";
